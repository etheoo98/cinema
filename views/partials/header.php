...
<header>
    <div class="container">
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            <div class="dropdown">
                <input type="image" onclick="myFunction()" class="drop-button" src="<?php echo $grav_url; ?>" alt="Avatar">
            ...
            <script src="/cinema/public/js/header-dropdown.js"></script>

        <?php
        } else {
        ?>
            <a id="sign-in" href="/cinema/sign-in">Sign In/Up</a>
        <?php } ?>
</header>