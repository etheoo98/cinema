<form class="admin-form" id="edit-movie-form" enctype="multipart/form-data" data-action="edit-movie" method="POST">
    ...
    <div class="add-movie-container">
        ...
        <div class="input-row" id="subtitles">
                ...
                <div>
                    <input type="radio" id="subtitles-yes" name="subtitles" value="1" <?php if ($this->movieData['subtitles'] === 1) echo 'checked'; ?>>
                    <label for="subtitles-yes">Yes</label>
                    <input type="radio" id="subtitles-no" name="subtitles" value="0" <?php if ($this->movieData['subtitles'] === 0) echo 'checked'; ?>>
        ...
        <div class="input-row" id="screening">
                ...
                <div>
                    <input type="radio" id="screening-yes" name="screening" value="1" <?php if ($this->movieData['showing'] === 1) echo 'checked'; ?>>
                    <label for="screening-yes">Yes</label>
                    <input type="radio" id="screening-no" name="screening" value="0" <?php if ($this->movieData['showing'] === 0) echo 'checked'; ?>>
